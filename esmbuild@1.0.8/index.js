...
var require_lib = __commonJS({
  "node_modules/@liveblocks/react/lib/index.js"(exports) {
    ...
    var ServerMessageType2;
    (function(ServerMessageType3) {
      ServerMessageType3[ServerMessageType3["UpdatePresence"] = 100] = "UpdatePresence";
      ServerMessageType3[ServerMessageType3["UserJoined"] = 101] = "UserJoined";
      ServerMessageType3[ServerMessageType3["UserLeft"] = 102] = "UserLeft";
      ServerMessageType3[ServerMessageType3["Event"] = 103] = "Event";
      ServerMessageType3[ServerMessageType3["RoomState"] = 104] = "RoomState";
      ServerMessageType3[ServerMessageType3["InitialStorageState"] = 200] = "InitialStorageState";
      ServerMessageType3[ServerMessageType3["UpdateStorage"] = 201] = "UpdateStorage";
    })(ServerMessageType2 || (ServerMessageType2 = {}));
    var ClientMessageType2;
    (function(ClientMessageType3) {
      ClientMessageType3[ClientMessageType3["UpdatePresence"] = 100] = "UpdatePresence";
      ClientMessageType3[ClientMessageType3["ClientEvent"] = 103] = "ClientEvent";
      ClientMessageType3[ClientMessageType3["FetchStorage"] = 200] = "FetchStorage";
      ClientMessageType3[ClientMessageType3["UpdateStorage"] = 201] = "UpdateStorage";
    })(ClientMessageType2 || (ClientMessageType2 = {}));
    var CrdtType2;
    (function(CrdtType3) {
      CrdtType3[CrdtType3["Record"] = 0] = "Record";
      CrdtType3[CrdtType3["List"] = 1] = "List";
      CrdtType3[CrdtType3["Register"] = 2] = "Register";
    })(CrdtType2 || (CrdtType2 = {}));
    var OpType2;
    (function(OpType3) {
      OpType3[OpType3["Init"] = 100] = "Init";
      OpType3[OpType3["ListInsert"] = 200] = "ListInsert";
      OpType3[OpType3["ListMove"] = 201] = "ListMove";
      OpType3[OpType3["ListRemove"] = 202] = "ListRemove";
      OpType3[OpType3["RecordUpdate"] = 300] = "RecordUpdate";
    })(OpType2 || (OpType2 = {}));
    var WebsocketCloseCodes2;
    (function(WebsocketCloseCodes3) {
      WebsocketCloseCodes3[WebsocketCloseCodes3["CLOSE_ABNORMAL"] = 1006] = "CLOSE_ABNORMAL";
      WebsocketCloseCodes3[WebsocketCloseCodes3["INVALID_MESSAGE_FORMAT"] = 4e3] = "INVALID_MESSAGE_FORMAT";
      WebsocketCloseCodes3[WebsocketCloseCodes3["NOT_ALLOWED"] = 4001] = "NOT_ALLOWED";
      WebsocketCloseCodes3[WebsocketCloseCodes3["MAX_NUMBER_OF_MESSAGES_PER_SECONDS"] = 4002] = "MAX_NUMBER_OF_MESSAGES_PER_SECONDS";
      WebsocketCloseCodes3[WebsocketCloseCodes3["MAX_NUMBER_OF_CONCURRENT_CONNECTIONS"] = 4003] = "MAX_NUMBER_OF_CONCURRENT_CONNECTIONS";
      WebsocketCloseCodes3[WebsocketCloseCodes3["MAX_NUMBER_OF_MESSAGES_PER_DAY_PER_APP"] = 4004] = "MAX_NUMBER_OF_MESSAGES_PER_DAY_PER_APP";
      WebsocketCloseCodes3[WebsocketCloseCodes3["MAX_NUMBER_OF_CONCURRENT_CONNECTIONS_PER_ROOM"] = 4005] = "MAX_NUMBER_OF_CONCURRENT_CONNECTIONS_PER_ROOM";
    })(WebsocketCloseCodes2 || (WebsocketCloseCodes2 = {}));
    var LiveStorageState2;
    (function(LiveStorageState3) {
      LiveStorageState3[LiveStorageState3["NotInitialized"] = 0] = "NotInitialized";
      LiveStorageState3[LiveStorageState3["Loading"] = 1] = "Loading";
      LiveStorageState3[LiveStorageState3["Loaded"] = 2] = "Loaded";
    })(LiveStorageState2 || (LiveStorageState2 = {}));
    ...
    function useStorage(initialStorage) {
      ...
      var root = storage.state === LiveStorageState2.Loaded ? storage.root : null;
    ...
    exports.RoomProvider = RoomProvider2;
    exports.useBroadcastEvent = useBroadcastEvent;
    exports.useErrorListener = useErrorListener;
    exports.useEventListener = useEventListener;
    exports.useMyPresence = useMyPresence2;
    exports.useOthers = useOthers2;
...
var export_LiveblocksProvider = import_react.LiveblocksProvider;
var export_RoomProvider = import_react.RoomProvider;
var export_useMyPresence = import_react.useMyPresence;
var export_useOthers = import_react.useOthers;
export {
  Battery,
  Button,
  export_LiveblocksProvider as LiveblocksProvider,
  MotionButton,
  export_RoomProvider as RoomProvider,
  createClient,
  export_useMyPresence as useMyPresence,
  export_useOthers as useOthers
};
